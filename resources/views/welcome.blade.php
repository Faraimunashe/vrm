...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Welcome to <span>Vehicle & License Checking System</span></h1>
      <h2>We are team of talented designers making websites with Bootstrap</h2>
      <div class="d-flex">
        <a href="{{route('login')}}" class="btn-get-started scrollto">Get Started</a>
        <a href="https://www.youtube.com/watch?v=cBeCfnkn9V0" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span></span></a>
      </div>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <img src="{{asset('things/assets/img/arms.jpeg')}}" class="img-fluid" alt="">
          </div>
        </div>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>F.A.Q</h2>
          <h3>Central Vehicle Registry
            <span>CVR</span></h3>
          <p>It is a department under Transport Management Division and are a sister department to VID and RMT created in terms of the Vehicle Licensing Act (Chap 13:14) [section 3 refers].</p>
        </div>
